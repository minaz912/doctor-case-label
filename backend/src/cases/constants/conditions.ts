/**
 * CD10 conditions are defined as constant instead of being stored
 * in the DB because it's not worth the DB roundtrip to fetch records
 * of a small number/size which do not change over time
 */
